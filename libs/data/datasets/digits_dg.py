...
class DigitsDG(DatasetBase):
    ...
    def __init__(self, cfg, root="datasets"):
        ...
        self.src_domains = cfg.DG.DATASET.SRC_DOMAINS
        self.tgt_domains = cfg.DG.DATASET.TGT_DOMAINS
        self.check_input_domains(self.src_domains, self.tgt_domains)

        train = self._read_data(cfg.DG.DATASET.SRC_DOMAINS, "train")
        val = self._read_data(cfg.DG.DATASET.SRC_DOMAINS, "val")
        test = self._read_data(cfg.DG.DATASET.TGT_DOMAINS, "all")
