# https://github.com/mlfoundations/open_clip/blob/main/src/training/profiler.py
import argparse

import torch
import pandas as pd
# from torch.utils.flop_counter import FlopCounterMode # > PyTorch 2.1
...
def profile_model(model, batch_size=1, profiler="torch"):
    assert profiler in [
        "torch",
        "fvcore",
